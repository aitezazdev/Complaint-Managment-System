...
const AdminComplaints = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-semibold text-gray-900">All Complaints</h1>
        <p className="mt-1 text-sm text-gray-600">Manage and track all user complaints</p>
      </div>
            ...
            <div className="p-6 space-y-4">
              ...
              {selectedComplaint?.adminNotes && (
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
                  <p className="text-xs font-medium text-yellow-800 mb-1">Previous Notes:</p>
                  <p className="text-sm text-yellow-700">{selectedComplaint.adminNotes}</p>
                </div>
              )}
            </div>
